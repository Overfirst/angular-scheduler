...
import { SchedulerEvent, ViewDetalization } from 'src/app/modules/scheduler/interfaces';
import { SchedulerService } from 'src/app/modules/scheduler/services/scheduler.service';
